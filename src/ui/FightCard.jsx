          ...
          {mainCardFights.length === 0 ? (
            ...
            mainCardFights.map((fight, i) => (
              <li className="pb-2" key={i}>
                <a
                  className="inline-flex justify-center pt-2 w-48 md:w-60 h-10 rounded-md text-md font-medium text-gray-100 bg-red-600 hover:bg-red-400"
                ...
                <a
                  className="inline-flex justify-center pt-2 w-48 md:w-60 h-10 rounded-md text-md font-medium text-gray-100 bg-blue-600 hover:bg-blue-400"
